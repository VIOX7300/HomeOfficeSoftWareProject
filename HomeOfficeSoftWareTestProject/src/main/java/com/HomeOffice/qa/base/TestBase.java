package com.HomeOffice.qa.base;
...
public class TestBase {
	...
	public TestBase(){		
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\com\\HomeOffice\\qa\\config\\config.properties");
		    prop.load(ip);
