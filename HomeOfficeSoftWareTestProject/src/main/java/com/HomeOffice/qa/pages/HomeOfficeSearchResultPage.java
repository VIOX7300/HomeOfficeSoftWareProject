package com.HomeOffice.qa.pages;
...
public class HomeOfficeSearchResultPage extends TestBase {
	 
	@FindBy(xpath="//a/h3[contains(text(),'Home Office')]")
	
	private List<WebElement> searchResults;
	
	public HomeOfficeSearchResultPage(){
	...
	public void verifyText(String text){
		for(int i=0; i<getResults().size();i++){			 
			Assert.assertTrue((getResults().get(i).getText().contains("Home Office")));
		}	
